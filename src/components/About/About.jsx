...
import airjordan from '../../images/airjordan.jpg'
            ...
            <Grid container justifyContent='center' alignItems="center">
                <Grid item lg={6} xs={12}>
                    ...
                    <Typography variant="h5" gutterBottom component="p">
                        Hi I am Aditya Chavan. df djfhd fjhdf jshfdisdus kdf sifuisudf dsij fisuf isu fisufd isu ifusfd isufdisudfisdfsdfubkdjfbvdvn r,ufversliubrevh rvjhvbvkifujvfikvdfu
                    </Typography>
                </Grid>
                <Grid container item direction="column" lg={6} xs={12} justifyContent="center" alignItems="center">
                    <Grid item>
                        <img  src={airjordan} width="200px" height="200px"/>
                    </Grid>
                    <Grid container item direction="row" spacing={4} justifyContent="center">
                        <Grid item>
                            <Tooltip title="instagram">
                                <Avatar variant='rounded' style={{backgroundColor: '#E4405F'}} >
                        ...
                        <Grid item>
                            <Tooltip title="Twitter">
                                <Avatar variant="rounded" style={{backgroundColor: '#1DA1F2'}} >
                                    <svg  width={"30px"} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <title>Twitter</title>
